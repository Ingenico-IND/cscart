...
if($mode == "refund")
{
    if (defined('AJAX_REQUEST')) {
        ...
        $responseHtml = '<table class="table table-bordered table-hover"><tr class="info"><th width="100%" colspan=2 style="background: #000000;color: #ffffff;">Refund Result</th></tr><tr><td style="color: #0388cc;font-weight: 900;">Merchant Code</td><td>'. $refundData["merchantCode"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Merchant Transaction Reference No</td><td>' . $refundData["merchantTransactionIdentifier"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">TPSL Transaction ID</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["identifier"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Refund Identifier</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["refundIdentifier"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Amount</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["amount"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Message</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["errorMessage"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Status Code</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["statusCode"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Status Message</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["statusMessage"] .'</td></tr><tr><td style="color: #0388cc;font-weight: 900;">Date Time</td><td>' . $refundData["paymentMethod"]["paymentTransaction"]["dateTime"] .'</td></tr></table>';
